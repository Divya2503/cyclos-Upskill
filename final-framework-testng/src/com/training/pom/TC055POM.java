...
public class TC055POM {
	private WebDriver driver; 
	
	public TC055POM(WebDriver driver) {
		this.driver = driver; 
	...
	//To find Member in the Member Registration page //
	...
	//To find Submit Button of Chnage Permissions Group in the Profile page //
	...
	//To find Amount in the Grant Loan to Member page  //
	@FindBy(id ="amount")
	private WebElement LoanAmount; 

	//To find Description in the Grant Loan to Member page  //
	@FindBy(xpath ="//*[@id=\"description\"]")
	private WebElement Description;
	
	
	//To find Submit Button in the Grant Loan to Member page  //
	@FindBy(xpath ="//*[@id=\"tdContents\"]/form/table[1]/tbody/tr[2]/td/table/tbody/tr[17]/td/input")
	private WebElement Submit6;
	
	
	//To find Submit Button in the Grant Loan to Member page  //
	@FindBy(xpath ="//*[@id=\"tdContents\"]/form/table[1]/tbody/tr[2]/td/table/tbody/tr[7]/td/input")
	private WebElement Submit7;
	...
	public void sendLoanAmount(String LoanAmount) {
	...
	public void sendMemberLoign(String string) {
		// TODO Auto-generated method stub
